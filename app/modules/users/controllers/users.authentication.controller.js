(function () {
    ...
    AuthenticationController.$inject = ['$state', 'PasswordValidator', 'UsersService', 'Notification', 'Authentication'];

    function AuthenticationController($state, PasswordValidator, UsersService, Notification, Authentication) {
        var test = "Test";
        var vm = this;
        ...
        function signin(isValid) {
            ...
            if (!isValid) {
                ...
                //strange book usernameoremail doesnt work? -> but same like meanjs
                //TODO:fix this
