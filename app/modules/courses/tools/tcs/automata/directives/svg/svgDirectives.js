angular.module('courses.tcs').directive("ownSvg", function () {
    return {
        transclude: true,
        replace: true,
...
angular.module('courses.tcs').directive("svgDefinitions", function () {
    return {
        restrict: 'E',
        replace: true,
...
angular.module('courses.tcs').directive("svgOuter", function () {
    return {
        restrict: 'E',
        replace: true,
        transclude: true,
...
angular.module('courses.tcs').directive("svgTransitionPn", function () {
    return {
        replace: true,
        restrict: 'E',
        scope: {
        ...
        ,
        templateUrl: 'modules/courses/tools/tcs/automata/directives/svg/svg-transitionPN.html'
    };
});
...
angular.module('courses.tcs').directive("svgTmpTransition", function () {
    return {
        replace: true,
        restrict: 'E',
        templateNamespace: 'svg',
...
angular.module('courses.tcs').directive("changeInputFieldValue", function () {
    return {
        restrict: 'E',
        scope: {
            char: '@char'
...
angular.module('courses.tcs').directive("svgPdaStack", function () {
    return {
        replace: true,
        restrict: 'E',
        templateNamespace: 'svg',
