...
autoSim.DFACore = function ($scope) {
    ...
    self.resetAutomatonRequest = function(){
        $scope.$uibModal.open({
            ...
            templateUrl: '/modules/tools/automata/directives/modal/resetAutomaton/resetAutomaton.modal.view.html',
    ...
    self.openInfoModal = function(title,description){
        $scope.$uibModal.open({
            ariaLabelledBy: 'modal-title',
            templateUrl: '/modules/tools/automata/directives/modal/info/info.modal.view.html',
